...
!(function (t, e) {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define(
          ["ev-emitter/ev-emitter", "unipointer/unipointer"],
          function (n, i) {
            return e(t, n, i);
          }
        )
      : "object" == typeof module && module.exports
      ? (module.exports = e(t, require("ev-emitter"), require("unipointer")))
      : (t.Huebee = e(t, t.EvEmitter, t.Unipointer));
  })(window, function (t, e, n) {
    function i(t, e) {
      if (((t = h(t)), !t)) throw "Bad element for Huebee: " + t;
      (this.anchor = t),
        (this.options = {}),
        this.option(i.defaults),
        this.option(e),
        this.create();
    }
    function o() {
      for (
        var t = document.querySelectorAll("[data-huebee]"), e = 0;
        e < t.length;
        e++
      ) {
        var n,
        ...
        try {
          ...
          C &&
            C.error("Error parsing data-huebee on " + o.className + ": " + t);
          continue;
        }
        new i(o, n);
      }
    ...
    (f.create = function () {
      ...
      (n.className = "huebee "),
        (n.className += this.options.staticOpen
          ? "is-static-open "
          : "is-hidden "),
    ...
    (f.createCloseButton = function () {
      ...
      (f.addSwatch = function (t, e, n) {
        (this.swatches[e + "," + n] = t),
          (this.colorGrid[t.color.toUpperCase()] = { x: e, y: n });
      });
    var E = {
      hsl: function (t, e, n) {
        return (
    ...
    (f.open = function () {
      if (!this.isOpen) {
        ...
        (this.hasTransition = n && "none" != n && parseFloat(n)),
          (this.isOpen = !0),
          this.updateSizes(),
          this.renderColors(),
          this.setAnchorColor();
      ...
      (f.bindOpenEvents = function (t) {
        if (!this.options.staticOpen) {
          ...
          g[e]("mousedown", this.outsideCloseIt),
            g[e]("touchstart", this.outsideCloseIt),
      ...
      (f.updateSizes = function () {
        ...
        (this.cursorBorder = parseInt(
          ...
          (this.gridSize = Math.round(
            this.cursor.offsetWidth - 2 * this.cursorBorder
          )),
          (this.canvasOffset = {
        ...
        var i = Math.max(e * n + this.satY, e + 2),
          o = this.gridSize * (t + 2);
        (this.canvas.width = 2 * o),
          (this.canvas.style.width = o + "px"),
          (this.canvas.height = this.gridSize * i * 2);
      }),
    ...
    (f.close = function () {
      this.isOpen &&
        (w && this.hasTransition
          ? this.element.addEventListener(
              "transitionend",
              this.onElemTransitionend
            )
          : this.remove(),
      ...
      (f.setSwatch = function (t) {
        ...
        if (t) {
          ...
          (this.color = e),
            ...
            (this.sat = t.sat),
            (this.lum = t.lum);
          var i = this.lum - 0.15 * Math.cos(((this.hue + 70) / 180) * Math.PI);
          this.isLight = i > 0.5;
          var o = this.colorGrid[e.toUpperCase()];
          this.updateCursor(o),
            this.setTexts(),
            this.setBackgrounds(),
            n || this.emitEvent("change", [e, t.hue, t.sat, t.lum]);
        }
      }),
      (f.setTexts = function () {
      ...
      (f.setBackgrounds = function () {
        if (this.setBGElems)
          for (
            var t = this.isLight ? "#222" : "white", e = 0;
            e < this.setBGElems.length;
            e++
          ) {
        ...
        if (this.isOpen) {
          ...
          if ((this.cursor.classList[e]("is-hidden"), t)) {
            var n = this.gridSize,
              i = this.canvasOffset,
              o = this.cursorBorder;
            (this.cursor.style.left = t.x * n + i.x - o + "px"),
              (this.cursor.style.top = t.y * n + i.y - o + "px");
          }
        }
      });
    var C = t.console,
